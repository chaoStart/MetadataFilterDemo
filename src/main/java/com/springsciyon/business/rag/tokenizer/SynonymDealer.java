...
public class SynonymDealer {
    ...
    public SynonymDealer() {
        ...
        String path = Paths.get(getProjectBaseDirectory(), "target","utils", "res", "synonym.json").toString();
...
//            Gson gson = new Gson();
            ...
            dictionary = gson.fromJson(jsonElement, type);
        } catch (Exception e) {
